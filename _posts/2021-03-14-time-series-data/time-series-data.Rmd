...
description: |
  Time series of fish passage at Willamette Falls (group assignment)
author:
  - name: Larissa Neilson, Iris Foxfoot, Joe Walderman
    url: {}
date: 2021-03-14
output:
...
## Willamette Falls Fish Passage Time Series {.tabset}

### Original Time Series

```{r}
#first read in the data
fish_passage <- read_csv(here("willamette_fish_passage.csv")) %>% 
  clean_names()
